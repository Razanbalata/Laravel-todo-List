...
@endphp
@section('style',
    'w-full max-w-[480px] mx-auto bg-surface-container-lowest border border-outline-variant rounded-xl p-8 md:p-12
    ...
    <form action="{{ route('register.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input
                ...
                id="name" name="name" placeholder="E.g. Julian Barnes" required="" type="text" />
        </div>
        <div>
        ...
        <div>
            <label class="block font-ui-label text-ui-label text-on-surface mb-2" for="password">Password</label>
            <div class="relative">
                <input
                    class="w-full px-4 py-3 rounded-lg border border-outline-variant bg-surface focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-all outline-none font-ui-label"
                    id="password" name="password" placeholder="At least 12 characters" required="" type="password" />
                <button
            ...
            <div>
                <label class="block font-ui-label text-ui-label text-on-surface mb-2" for="password_confirmation">
